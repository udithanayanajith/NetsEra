...
const UseCaseCard = ({ onFillData }: { onFillData: (route: typeof SAMPLE_ROUTES[0]) => void }) => {
  return (
    <Card>
      <CardHeader>
      ...
      <CardContent>
        <div className="space-y-4">
          <div className="text-sm text-gray-400">
            <p className="font-semibold text-white mb-2">Scenario: Department Network Configuration</p>
          ...
          <div className="mt-4 bg-gray-800 p-4 rounded-lg">
            <h3 className="text-white font-semibold mb-2">Example CLI Commands:</h3>
...
export default function StaticRouting() {
  ...
  // Add new states for CLI modes and suggestions
  ...
  const validateCommand = (
    ...
    // Special commands that are always valid
  ...
  const handleCommand = (e: React.FormEvent) => {
    ...
    // Validate and handle other commands
